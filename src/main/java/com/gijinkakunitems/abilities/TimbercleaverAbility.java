...
public class TimbercleaverAbility {
    ...
    public static void apply(PlayerDeathEvent event, GijinkakunItems plugin) {
        ...
        if (killer != null && isSpecialItem(killer.getInventory().getItemInMainHand(), "timbercleaver", plugin)) {
            CustomDeathMessageHandler.handleDeathMessage(event, "timbercleaver", killer);
        }
    }
